...
const ACTIVITY = [
  ...
  { agent: '分析师', action: '生成周报', time: '18 分钟前', type: 'report' },
  { agent: '支持专员', action: '解决 5 个工单', time: '22 分钟前', type: 'support' },
  { agent: '策略师', action: '更新策略文档', time: '25 分钟前', type: 'strategy' },
]

// Mock missions/tasks
const MISSIONS = [
  { id: 1, title: 'Q1 路线图', status: 'active', progress: 75, agents: ['ceo', 'strategist'] },
  { id: 2, title: '活动上线', status: 'active', progress: 45, agents: ['creative', 'writer'] },
  { id: 3, title: '系统升级', status: 'pending', progress: 10, agents: ['developer', 'analyst'] },
  { id: 4, title: '市场分析', status: 'completed', progress: 100, agents: ['researcher', 'analyst'] },
]
