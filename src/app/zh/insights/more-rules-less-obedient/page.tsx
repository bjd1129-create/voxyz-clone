...
export default function MoreRulesLessObedientPage() {
  return (
    <main className="min-h-screen p-3 sm:p-6">
      {/* Mobile Navigation */}
      <MobileNav langToggleHref="/insights" />
      ...
      <header className="hidden md:block max-w-4xl mx-auto mb-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/insights/more-rules-less-obedient" className="px-3 py-1.5 bg-white/10 rounded-lg text-sm hover:bg-white/20 transition-colors">
            EN / 中文
          </Link>
        </div>
      </header>
      ...
      <article className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <p className="text-gray-500 text-sm">
            *相关阅读: <Link href="/zh/insights/ai-company-7-weeks" className="text-white hover:underline">我建了一个 AI 公司。7 周后，它们比我还了解公司。</Link> | <Link href="/zh/insights/radar-is-not-dashboard" className="text-white hover:underline">Radar 不是仪表盘。是耳朵。</Link>*
          </p>
        </div>
      </article>
    </main>
