...
const pricingTiers = [
  {
    ...
    features: [
      '10 个 Agent 角色定义 + 协作流程',
      '一键部署脚本（Vercel/Cloudflare）',
      '飞书/微信/Telegram 配置模板',
      '20+ 失败模式文档',
      '基础监控仪表盘',
      '社区支持（飞书群组）',
    ...
    <div className="min-h-screen font-sans" style={{
      ...
      <section className="pt-20 pb-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8 leading-relaxed">
            完整的 AI Agent 团队构建方案。从角色定义到生产部署，
            <br />
            一次付费，永久更新。
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              ...
              <div className="text-sm text-white/40">AI Agent 角色</div>
            </div>
            <div>
              <div className="text-3xl font-bold mb-1" style={{ color: '#4ecdc4' }}>24/7</div>
              <div className="text-sm text-white/40">持续工作</div>
            </div>
            <div>
              <div className="text-3xl font-bold mb-1" style={{ color: '#4ecdc4' }}>5min</div>
              <div className="text-sm text-white/40">快速部署</div>
            </div>
            <div>
              <div className="text-3xl font-bold mb-1" style={{ color: '#4ecdc4' }}>∞</div>
              <div className="text-sm text-white/40">永久更新</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {pricingTiers.map((tier) => (
              ...
              >
                ...
                <div className="text-xs text-white/40 mb-4">{tier.audience}</div>
                ...
                <button 
                  ...
                  style={tier.highlight ? { background: 'linear-gradient(135deg, #22c55e, #4ecdc4)' } : {}}
                >
                  {tier.cta}
                </button>
              </div>
      ...
      <section className="py-16 px-6 border-t border-white/5">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Link 
            href="#pricing" 
            className="inline-block px-8 py-3 rounded-full text-sm font-medium text-black"
