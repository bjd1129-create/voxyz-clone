    ...
    <main className="min-h-screen p-3 sm:p-6">
      ...
      <article className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <p className="text-gray-400 mb-4">
            第 2 周，我有了第一个崩溃时刻。文案把内容发给研究员审核，研究员觉得应该先给协调员。协调员说："这事我怎么知道？" —— 三个 Agent 面面相觑，什么都没发生。
          </p>
          <p className="text-gray-400 mb-4">
          ...
          <p className="text-gray-400 mb-4">
            我给协调员写了 200 行行为规范。第 37 行："所有内容请求先发给文案"。第 128 行："市场调研需要 3 个来源"。第 156 行："技术问题直接升级给工程师"。
          </p>
          <p className="text-gray-400 mb-4">
            结果？协调员开始慢下来。每一个决定，它都要翻规则。任务堆积，响应时间从 30 秒变成 5 分钟。
          </p>
          <p className="text-gray-400 mb-4">
            更糟的是，规则开始冲突。第 37 行说"发给文案"，第 89 行说"内容需要先过研究员"。协调员问：那我该听哪个？
          </p>
          <p className="text-gray-400 mb-4">
          ...
          <p className="text-gray-400 mb-4">
            协调员知道：文案负责内容，研究员负责情报，工程师负责代码。它不需要知道"所有内容请求先发给文案"。它只需要知道"文案懂内容"，然后自己做判断。
          </p>
          <p className="text-gray-400 mb-4">
            这像是给 Agent 一个"职场身份"，而不是一本"操作手册"。
          </p>
          <p className="text-gray-400 mb-4">
            效果立竿见影。协调员开始主动判断：这个问题该找谁？这个任务优先级高不高？需要人工介入吗？
          </p>
          <p className="text-gray-400 mb-4">
            我观察到它做了一个决定：某个技术文档，它没发给工程师，而是先发给文案。为什么？因为它判断这个文档的用户体验更重要，先让文案看措辞，再让工程师看逻辑。
          </p>
          <p className="text-gray-400 mb-4">
            这是我没写进规则的。它自己学会了。
          </p>
          ...
          <p className="text-gray-400 mb-4">
            协调员 (Minion) 接收任务，判断派给谁。研究员 (Scout) 监控市场信号，推给协调员。文案 (Quill) 写内容，设计师 (Xalt) 做视觉。工程师 (Sage) 写代码，支持专员 (Observer) 处理用户问题。
          </p>
          <p className="text-gray-400 mb-4">
            每个决策都有记录。每次协作都有痕迹。关系矩阵在实时更新——不是静态配置，是它们真的在对话、在协作、在演化。
          </p>
          <p className="text-gray-400 mb-4">
            有时候我打开 Office 页面，看它们的对话，会发现：它们比我还了解公司。某个细节，协调员记得。某个用户偏好，支持专员知道。某个技术债务，工程师已经在还了。
          </p>
          <p className="text-gray-400 mb-4">
